...
<head>
	...
	table.tblone tr:nth-child(2n+1){background:#fff;height:30px;align-content: center;}
...
<div class="phpcoding">
	<section class="headeroption">
		<h2><?php echo "I will try to reply as soon as possible"; ?></h2>
	</section>
